...
Route::group(['middleware' => ['XSS', 'subscriptionAccessUrl']], function () {
    ...
    Route::get('header-about-section', 'Admin\FrontSettings\headerAboutSectionController@index')->name('header-about-section')->middleware('userRolePermission:650');
    Route::post('store-about-section', 'Admin\FrontSettings\headerAboutSectionController@store')->name('store-about-section')->middleware('userRolePermission:650');
    Route::get('edit-about-section/{id}', 'Admin\FrontSettings\headerAboutSectionController@edit')->name('edit-about-section')->middleware('userRolePermission:650');
    Route::get('details-about-section/{id}', 'Admin\FrontSettings\headerAboutSectionController@details')->name('details-about-section')->middleware('userRolePermission:650');
    Route::get('delete-about-section/{id}', 'Admin\FrontSettings\headerAboutSectionController@delete')->name('delete-about-section')->middleware('userRolePermission:650');
    Route::get('for-about-delete/{id}', 'Admin\FrontSettings\headerAboutSectionController@forDeleteAbout')->name('for-about-delete')->middleware('userRolePermission:650');
    Route::post('update-about-section', 'Admin\FrontSettings\headerAboutSectionController@update')->name('update-about-section')->middleware('userRolePermission:650');
